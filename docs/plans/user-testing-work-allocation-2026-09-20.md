...
| **fork #4** `03b9dd8`, draft | Imad owns the incremental UT-22 remembered-account choice on #74 `c910829`: 16 focused/436 source/17 harness tests, type/build and 15 built-app browser journeys pass. Initial `b763063` CI passed; reset-return follow-up CI is separate. Confirmation callbacks, household/consent and independent review remain open. |
...
| #34 `5af5ac2`, #36 `ab6c0c2`, #37 `b0cb7ab` | Imad has implemented and propagated one forward academy-history repair across all three fork branches, preserving every published migration. #34/#36/#37 fork and upstream PR CI pass; deployment jobs were skipped. All include #44 `8e72e80`; independent review and production approval remain. |
