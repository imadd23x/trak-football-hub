...
| #34 `5af5ac2`, #36 `ab6c0c2`, #37 `b0cb7ab` | Imad has implemented and propagated one forward academy-history repair across all three fork branches, preserving every published migration. #34 fork/upstream CI pass; #36/#37 local suites pass and current-head CI is running. All include #44 `8e72e80`; independent review and production approval remain. |
