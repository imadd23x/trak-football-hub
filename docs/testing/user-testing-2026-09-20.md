...
| UT-33 | Coach/player avatar upload fails | Reported; joint profile/storage | Upload and replace own avatar, size/type errors and retry, reload persistence; other-account denied; deletion handling |
