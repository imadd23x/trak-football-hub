...
const modes = ['--all', '--baseline', '--pilot-views-review', '--pilot-views-baseline', '--parent-upgrade-review', '--account-deletion-review'];
...
try {
  ...
  const suites = mode === '--account-deletion-review' ? ['account_deletion.sql']
