...
// Preserve this integration hook when regenerating the client. Capture before
// createClient starts consuming the URL; subscribe immediately after creation.
let recoveryCallbackUrl = window.location.href;
...
export const passwordRecovery = createPasswordRecovery(
  supabase.auth, recoveryCallbackUrl, SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY,
);
recoveryCallbackUrl = '';
