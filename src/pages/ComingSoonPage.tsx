...
export default function ComingSoonPage({ feature, home, homeLabel = 'Back to home' }: { feature: string; home: string; homeLabel?: string }) {
  return <MobileShell>
    <main className="py-16 space-y-4">
      ...
      <Link to={home} className="inline-flex min-h-11 items-center rounded-lg border border-border px-4 text-sm text-foreground focus-visible:ring-2 focus-visible:ring-primary">{homeLabel}</Link>
    </main>
  </MobileShell>
}
